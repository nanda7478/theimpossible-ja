...
<?php if ( $has_orders ) : ?>
	...
	<table class="woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table my_table_orders">
		<thead>
		<tr>
		<th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-number"><span class="nobr">注文</span></th>
		<th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-date"><span class="nobr">日付</span></th>
		<th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-status"><span class="nobr">状態</span></th>
		<th class="woocommerce-orders-table__header woocommerce-orders-table__header-order-total"><span class="nobr">合計</span></th>
		...
		<tbody>
			<?php foreach ( $customer_orders->orders as $customer_order ) :
				...
				<tr class="woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
					...
					<a href="<?php bloginfo('url'); ?>/myaccount/view-order/<?php echo $order->get_order_number(); ?>" class="woocommerce-button button view">注文の表示
					</a>
