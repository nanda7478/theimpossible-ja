...
<script type="text/javascript">
  ...
  var address = "http://theimpossibleco.com/ja/coins/?alltype=" + valv;
...
<script type="text/javascript">
    ...
    $("#artistname").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/coins/?alltype=" + alltypeartist + "&allatrist=" + artistname ;
      window.location.replace(address);
 ...
 <script type="text/javascript">
    ...
    $("#orderby").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/coins/?orderby=" + orderby;
      window.location.replace(address);
     });
  });
