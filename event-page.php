...
<script type="text/javascript">
  ...
  var address = "http://theimpossibleco.com/ja/events/?alltype=" + valv;
...
<script type="text/javascript">
    ...
    $("#artistname").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/events/?alltype=" + alltypeartist + "&allatrist=" + artistname ;
      window.location.replace(address);
 ...
 <script type="text/javascript">
    ...
    $("#orderby").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/events/?orderby=" + orderby;
      window.location.replace(address);
     });
  });
