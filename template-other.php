...
$args = array(
  ...
  $args = array(
    ...
    $totalcount = 1;
    $loopc = new WP_Query( $args ); ?> 

    <?php  if ( $loopc->have_posts() ) : ?>
       <div class="row" id="loaderpost">
       

        <?php while ( $loopc->have_posts() ) : $loopc->the_post(); 
           global $product; ?>
...
<script type="text/javascript">
  ...
  var address = "http://theimpossibleco.com/ja/other/?alltype=" + valv;
...
<script type="text/javascript">
    ...
    $("#artistname").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/other/?alltype=" + alltypeartist + "&allatrist=" + artistname ;
      window.location.replace(address);
 ...
 <script type="text/javascript">
    ...
    $("#orderby").change(function () {
     ...
     var address = "http://theimpossibleco.com/ja/other/?orderby=" + orderby;
      window.location.replace(address);
     });
  });
